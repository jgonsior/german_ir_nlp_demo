...
# indexing
conda run -n RAG_env_conda --no-capture-output python3 backend/RAGatouille/indexing.py --train_data GermanDPR-10neg --epochs 1 2 --num_parts 20
# evaluate
best_checkpoint_path_German_DPR=$(conda run -n RAG_env_conda --no-capture-output python3 backend/RAGatouille/evaluate.py --train_data GermanDPR-10neg --triples_path backend/data/qa/HP/eval_triples.jsonl --epochs 1 2 --num_parts 20 | tail -n 1)
...
# indexing
conda run -n RAG_env_conda --no-capture-output python3 backend/RAGatouille/indexing.py --train_data GermanDPR-XQA-10neg --epochs 1 2 --num_parts 20
# evaluate
best_checkpoint_path_XQA=$(conda run -n RAG_env_conda --no-capture-output python3 backend/RAGatouille/evaluate.py --train_data GermanDPR-XQA-10neg --triples_path backend/data/qa/HP/eval_triples.jsonl --epochs 1 2 --num_parts 20 | tail -n 1)
...
# indexing
conda run -n RAG_env_conda --no-capture-output python3 backend/RAGatouille/indexing.py --train_data GermanDPR-XQA-HP-10neg --epochs 1 2 --num_parts 20
# evaluate
best_checkpoint_path_HP=$(conda run -n RAG_env_conda --no-capture-output python3 backend/RAGatouille/evaluate.py --train_data GermanDPR-XQA-HP-10neg --triples_path backend/data/qa/HP/eval_triples.jsonl --epochs 1 2 --num_parts 20 | tail -n 1)
